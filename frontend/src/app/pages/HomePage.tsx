...
export default function HomePage({ userName }: HomePageProps) {
    ...
    const actions = [
        ...
        },
        {
            ...
            subtitle:
                'Listado de los alquileres con filtros y estados. Podes crear uno nuevo desde este apartado',
            color: 'bg-blue-50',
        ...
        },
        {
            ...
            title: 'Calendario',
            subtitle:
                'Visualizacion del estado de los alquileres que inician y finalizan en un dia determinado',
            color: 'bg-pink-50',
        ...
        },
        {
            ...
            title: 'Stock',
            subtitle:
                'Listado del inventario y disponibilidad de los productos. Podes crear uno nuevo desde este apartado',
            color: 'bg-amber-50',
        ...
        },
        {
            ...
            title: 'Clientes',
            subtitle:
                'Listado de todos los clientes registrados en el sistema. Podes crear uno nuevo desde este apartado',
            color: 'bg-purple-50',
        ...
        },
        {
            ...
            subtitle:
                'Opciones de configuración del sistema. Podes crear, editar y eliminar usuarios, roles y permisos. Acceso restringido a administradores',
            color: 'bg-purple-50',
            iconColor: 'text-green-600',
            path: '/app/sistema',
        },
    ...
    return (
        <main role="main" aria-label="Contenido principal">
            ...
            >
                <div>
                    <p
                        className="text-xs font-bold text-[#218a72] uppercase tracking-wider mb-0.5"
                        aria-label="Saludo"
                    >
                        Bienvenido/a
                    </p>
                    <h1
                        ...
                        aria-label={`Panel principal de ${userName || 'Tuki System'}`}
                    >
            ...
            <section className="px-5 pt-2 pb-5" aria-labelledby="kpis-titulo">
                ...
                <div
                    ...
                    role="list"
                    aria-label="Resumen de alquileres y estadísticas"
                >
                    {/* Activos */}
                    <article
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                {stats.vencidos > 0 ? (
                                    <p
                                        ...
                                        id="alerta-vencidos-descripcion"
                                    >
                                        Hay <strong>{stats.vencidos}</strong>{' '}
                                        alquiler
                                        {stats.vencidos === 1 ? '' : 'es'}{' '}
                                        vencido
                                        {stats.vencidos === 1 ? '' : 's'} que
                                        requieren revisión.
                                    </p>
                                ) : (
                                    <p
                                        ...
                                        id="alerta-vencidos-descripcion"
                                    >
                                        No hay alquileres vencidos actualmente.
                                    </p>
                                )}
                                <button
                                    onClick={() =>
                                        navigate(
                                            '/app/alquileres?filter=vencido',
                                        )
                                    }
            ...
            >
                <header className="mb-5">
                    <div
                        className="text-xs font-bold text-[#218a72] uppercase tracking-wider mb-1.5"
                    ...
                    {actions.map((action, idx) => (
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div
                                        className="font-bold text-gray-900 mb-1 text-base"
                                        aria-hidden="true"
                                    >
                                        {action.title}
                                    </div>
