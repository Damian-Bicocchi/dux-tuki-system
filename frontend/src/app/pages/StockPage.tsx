...
import { CategoriasTab } from "../pages/administracion/tabs/CategoriasTab"; // Ajusta la ruta según tu estructura
...
export default function StockPage() {
  ...
  // Función para cargar los datos (extraída con useCallback para reusarla)
  ...
  return (
    <div className="px-5 py-6 pb-10 min-h-screen bg-gradient-to-b from-white via-[#f7fbfa] to-white">
      ...
      {/* Navegación por pestañas homogénea */}
